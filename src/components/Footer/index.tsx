      ...
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="py-20 lg:py-25">
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                ...
                Introducing Kryptomerch.io, the revolutionary NFT launchpad marketplace and merchandising protocol that&apos;s taking the crypto world by storm. Kryptomerch is your gateway to the world&apos;s first NFT-based merchandising store and marketplace, offering a wide range of high-quality products with lightning-fast shipping. As a user, you can not only buy but also sell your NFT-based merchandising on our platform, providing more utility and value to your digital assets. Join the NFT revolution and unleash your creativity with Kryptomerch.io.                </p>
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} Copyright Kryptomerch. All Rights Reserved.
              </p>
            </motion.div>
